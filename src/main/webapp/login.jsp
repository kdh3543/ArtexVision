...
<body>
    ...
    <div class="btns_wrap">
      <div class="btns">
        <button id="signup_btn" class="signup_btn">회원가입</button>
        <button id="find_id_btn" class="find_id_btn">아이디 찾기</button>
        <button id="modify_pw_btn" class="modify_pw_btn">비밀번호 변경</button>
      </div>
    </div>
  </div>
</body>
