...
>>>>>>> 0a44f0ae9f6223a30be667d0158a57b79c34a085
      ...
      <div class="contents">
        <div class="contents_wrap1">
          <div class="contents_sub1">
            <img src="../img/love.png" width="200px" height="240px">
          </div>
        ...
        <div class="contents_wrap2">
          <div class="ex_title" style="font-weight: bolder; font-size: x-large; margin-bottom: 20px; padding-left: 90px;">연애의 온도:두 번째 이야기</div>
  ...
  <script type="text/javascript">
    ...
    mapOption = { 
        center: new kakao.maps.LatLng(37.59491027869021, 126.96325574396147), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
	...
	// 마커가 표시될 위치입니다 
	var markerPosition  = new kakao.maps.LatLng(37.59491027869021, 126.96325574396147); 
