      ...
      <div class="contents">
        <div class="contents_wrap1">
          <div class="contents_sub1">
            <img src="../img/yosigo.png" width="200px" height="240px">
          </div>
        ...
        <div class="contents_wrap2">
          <div class="ex_title" style="margin-bottom: 20px; padding-left: 90px;">
            <input type=text name ="ex_title" style="font-weight: bolder; font-size: x-large; text-align:center; border:0px;" value="요시고 사진전">
          </div>
        ...
        <div class="contents_wrap3">
          ...
          <div class="menu_content1">
            &nbsp&nbsp 요시고 사진전: 따뜻한 휴일의 기록은 그라운드시소 서촌에서 개최는 포토그래퍼 요시고의 국내 첫 개인전입니다.
            푸른 지중해를 둘러싼 유럽의 휴양지부터 마이애미, 두바이, 부다페스트 등 세계 여러 여행지를 기록한 350여 점의 사진들을 건축, 
            다큐멘터리, 풍경 세 가지 섹션으로 구분하여 선보입니다. 
            사진이 품고 있는 따듯한 온도를 느끼며 팬데믹이 가져다 준 피로와 갈증을 해소하고, 
            또 다른 내일을 향한 기대와 안정이 쌓이는 시간이 되길 바랍니다.
          </div>
