      ...
      <div class="contents">
        <div class="contents_wrap1">
          <div class="contents_sub1">
            <img src="../img/hashtag.png" width="200" height="240">
          </div>
        ...
        <div class="contents_wrap2">
          <div class="ex_title" style="margin-bottom: 20px; padding-left: 90px;">
         	<input type=text name ="ex_title" style="font-weight: bolder; font-size: x-large; text-align:center; border:0px;" value="프로젝트 해시태그 2021">
          </div>
          ...
          <div class="ex_person" >
            <div>인원</div>
            <div>
            <select name="person" style="width:120px; height:40px;" id="person" name="person">
              <option >인원 선택</option>
        ...
        <div class="contents_wrap3">
          ...
          <div class="menu_content1">
            &nbsp&nbsp국립현대미술관 공모사업인 《프로젝트 해시태그》는 기존 미술관에서 전시하고 기획하던 시각-중심적인 예술 형태나 시간-중심적인 예술 형식을 넘어선 새로운 플랫폼을 실험하고, 
            서로 다른 분야의 젊은 창작자들 간의 협업을 지원하도록 설계된 프로그램이다. 공모사업의 명칭 "해시태그(#)"는 소셜 플랫폼에서 #와 주제어를 붙이면 
