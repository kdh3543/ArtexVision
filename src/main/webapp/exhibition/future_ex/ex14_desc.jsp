      ...
      <div class="contents">
        <div class="contents_wrap1">
          <div class="contents_sub1">
            <img src="../img/book.png" width="200px" height="240px">
          </div>
        ...
        <div class="contents_wrap2">
          <div class="ex_title" style="font-weight: bolder; font-size: x-large; margin-bottom: 20px; padding-left: 90px;">내맘쏙 : 모두의 그림책 전</div>
        ...
        <div class="contents_wrap3">
          ...
          <div class="menu_content1">
            &nbsp&nbsp아이에게 기발한 상상력과 보는 즐거움을, 어른에게는 삶의 의미와 기억에 남는 메세지를 전합니다. 
            책으로 만났던 그림이 작품이 되었어요. 작가의 작품세계를 생생히 느낄 수 있는 원화와
            그림책에서 볼 수 없었던 미공개 컷들을 전시장에서 만나보세요!
            테어나서 가장 처음 접하는 책잉자 남녀노소 누구나 즐길 수 있는 그림책! 
            코로나로 지친 모두의 일상에 활력을 불어넣어 줄 전시!
            그림책과 연계된 전시장 속 다양한 포토존과 체험존을 경험해 보세요.
            직접 활동하는 체험을 통해 아이들의 창의력과 감수성을 키워주세요.
          </div>
...
<script type="text/javascript">
    $(document).ready(function () {
            ...
            $( "#choiceDate" ).datepicker({
                 ...
                 dateFormat: "yy-MM-dd",
                 minDate: new Date('2021-12-24'),// 선택할수있는 최소날짜, ( 0 : 오늘 이후 날짜 선택 불가)
	...
	var options = { //지도를 생성할 때 필요한 기본 옵션
		center: new kakao.maps.LatLng(37.480529546319666, 127.01422448688056), //지도의 중심좌표.
	...
	// 마커가 표시될 위치입니다 
	var markerPosition  = new kakao.maps.LatLng(37.480529546319666, 127.01422448688056); 
