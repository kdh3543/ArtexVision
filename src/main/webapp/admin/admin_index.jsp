	...
	<div class="container">
		...
		<div class="selection">
			...
			<div class="select_btn_form">
				...
				<button type="button" class="select_btn" id="daily_visit_btn">일간 방문자 통계 보기</button>
				<button type="button" class="select_btn" id="monthly_visit_btn">월간 방문자 통계 보기</button>
			</div>
		</div>
