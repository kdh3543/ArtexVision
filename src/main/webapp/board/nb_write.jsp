    ...
    <body>
          ...
          <div class="board_nb_content">
            ...
            <form action="/nb_writeProc.board" id="frmWrite">
              <div class="board_nb_write" style="width:100%;">
                <div class="board_nb_title"><input type=text placeholder="제목을 입력하세요" style="width:100%;" name="nb_title"
                    id="nb_title"></div>
                <div class="board_nb_contents" style="margin-top:10px;"><textarea placeholder="내용을 입력하세요."
                    style="width:100%; height: 330px;" name="nb_contents" id="nb_contents"></textarea></div>
              </div>
      ...
      <script>
        $("#write").on("click", function () {
          ...
          let nb_contents = $("#nb_contents").val();
