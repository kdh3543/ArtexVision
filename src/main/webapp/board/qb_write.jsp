        ...
        <div class="container2">
          ...
          <div class="board_qb_content">
            <div class="board_qb_boardname">
              ...
              <div>></div>
              <div class="board_qb_presentboard"><a href="/qb_list.board?cpage=1"
            ...
            <form action="/qb_writeProc.board" id="frmWrite">
              <div class="board_qb_write" style="width:100%;">
                <div class="board_qb_title"><input type=text placeholder="제목을 입력하세요" style="width:100%;" name="qb_title"
                    id="qb_title"></div>
